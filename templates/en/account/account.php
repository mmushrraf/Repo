								    ...
								    <div id="fees">
							            ...
							            <div class="row-fluid fees-holder">
							                ...
							                <div class="span4 pro">
							                    <div class="plan">
							                        <div class="wrapper">
							                            <img class="ribbon" src="../img/account/price-band.png" alt="Most Popular">
							                            <h3>Profesional</h3>
							                            <div class="price">
							                                <span class="dollar">€</span> 
...
<script type="text/javascript" src="../js/account/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="../js/account/select2.min.js"></script>
<script type='text/javascript' src='../js/account/jquery.validate.min.js'></script>
